...
export const post: BlogPost = {
  slug: "what-every-volleyball-parent-should-know-about-stats",
  title: "What Every Volleyball Parent Should Know About Stats",
  metaTitle: "Volleyball Stats for Parents: A Plain-English Guide",
  metaDescription:
    "Confused by your kid's stat sheet? This volleyball parent guide explains kills, digs, passing grades, and why position changes everything.",
  date: "2026-05-23",
  excerpt:
    "A plain-English breakdown of volleyball stats that helps parents support their athlete without adding pressure.",
  keywords: ["volleyball stats for parents", "volleyball parent guide"],
  related: [
    "comparing-liberos-to-hitters",
    "end-of-season-volleyball-report-cards",
    "how-to-give-volleyball-players-feedback",
  ],
  body: `If you've ever squinted at a stat sheet your kid's coach sent home and wondered what any of it means — or felt a knot in your stomach when the numbers looked low — this volleyball stats for parents guide is for you. You're not supposed to be an expert. You're supposed to cheer. Let's make the numbers less scary.
...
If you're curious how position affects fair evaluation, [this post on comparing liberos to hitters](/blog/comparing-liberos-to-hitters) goes deeper on exactly that problem.
...
If you want to go deeper on what good feedback looks like — the kind coaches give that actually sticks — [this guide on giving volleyball players feedback](/blog/how-to-give-volleyball-players-feedback) is worth a read.
