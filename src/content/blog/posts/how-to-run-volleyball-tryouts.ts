...
export const post: BlogPost = {
  slug: "how-to-run-volleyball-tryouts",
  title: "How to Run Volleyball Tryouts: A Coach's Guide",
  metaTitle: "How to Run Volleyball Tryouts: A Coach's Guide",
  metaDescription:
    "How to run volleyball tryouts fairly: what to evaluate by position, which drills to use as stations, and how to score players without bias.",
  date: "2026-06-03",
  excerpt:
    "A practical framework for running volleyball tryouts that evaluates each position fairly, uses real drills as stations, and gives you written criteria before the first athlete walks in.",
  keywords: ["volleyball tryouts", "volleyball tryout drills"],
  related: [
  ...
  body: `Running volleyball tryouts well is harder than it looks. Most coaches have a general sense of who they want to keep — but without a written framework, volleyball tryouts can drift into picking athletes who look the part rather than the ones who'll help you win matches. Here's a system that works.
...
1. **Approach Footwork Lines** (10 min) — catches hitters and middles; liberos do Lateral Movement Passing simultaneously
2. **Servers vs. Passers** (20 min) — passers graded 0–3 out loud on every rep; rotates everyone through
3. **Box Blocking** (15 min) — middles and outsides; [Watch: Box Blocking](https://www.youtube.com/results?search_query=volleyball+box+blocking+drill) focuses on jump timing and spread fingers
4. **Queen of the Court** (20 min) — teams of three; every player touches, no one can hide
